...
public class CustomerController {
	...
	@PostMapping("/{email}")
	public ResponseEntity<Customer> checkEmail(@Valid @RequestBody String emailId, Model m, Customer customer)
			throws ResourceNotFoundException {
		m.addAttribute("check", customervalid.checkEmail(emailId, customer));
		return customervalid.checkEmail(emailId, customer);
	}
